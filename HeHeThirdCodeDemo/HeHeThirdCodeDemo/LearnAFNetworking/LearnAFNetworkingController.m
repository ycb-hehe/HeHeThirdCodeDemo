...
@property (weak, nonatomic) IBOutlet UITextView *logsTV;
...
#warning 如果想使用示例中的API，需要自己注册 http://www.idataapi.cn/ 获得对应的key*/
    ...
    [[self shareAFNManager] GET:url parameters:parameters progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        //输出到界面//
        self.logsTV.text = [NSString stringWithFormat:@"%@",responseObject];
        ...
        self.logsTV.text = [NSString stringWithFormat:@"%@",[error.userInfo objectForKey:NSUnderlyingErrorKey]];
    }];
